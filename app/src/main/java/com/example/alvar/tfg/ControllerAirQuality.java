...
public class ControllerAirQuality extends Fragment {
    ...
    private ControllerAirQuality mainFragment;
    ...
    public ControllerAirQuality() {

    }
    public ControllerAirQuality(String id, Boolean my) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.layout_controller_air_quality,
                container, false);
