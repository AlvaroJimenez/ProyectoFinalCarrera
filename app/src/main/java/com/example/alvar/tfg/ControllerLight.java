...
public class ControllerLight extends Fragment {
    ...
    private ControllerLight mainFragment;
    ...
    public ControllerLight(String id, Boolean my) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.layout_controller_light,
                container, false);
        ...
        switchView.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                String idActuator = Cache.getInstance().allCjtSensores.actuatorIdBySala(sensorItem.getUbicacion(),"Light");
                ...
                if (switchView.isChecked()) {
                    cambiarIcono(1);
                    req = new HttpRequestPut(idActuator, Cache.getInstance().mainActivity, "Light",1, 0);

                }
                else {
                    cambiarIcono(0);
                    req = new HttpRequestPut(idActuator, Cache.getInstance().mainActivity, "Light",0, 0);
